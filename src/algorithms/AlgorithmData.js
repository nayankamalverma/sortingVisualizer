...
import BinarySearch from '../algorithms/Binary';
...
let AlgorithmData = {
    ...
    'Binary Search' : {
        ...
        definition : 'Binary search looks for a particular item by comparing the middle most item of the collection. If a match occurs, then the index of item is returned. If the middle item is greater than the item, then the item is searched in the sub-array to the left of the middle item.',
        working : ['Set the low index to the first element of the array and the high index to the last element.',
        ...
        steps : ['Consider an array arr[] = {2, 5, 8, 12, 16, 23, 38, 56, 72, 91}, and the target = 23.',
