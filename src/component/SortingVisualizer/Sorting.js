...
import Quiz from '../McqPage/mcqpage';
...
class Sorting extends Component {
    ...
    quiz=()=>{
        ...
        toast.info(<div><p>Do you want to take Quiz?</p>
            <button className='cstBtn' > <Link to="/Quiz" state={{ algo: this.state.algorithm  }} >yes</Link></button>
            <button className='cstBtn' >No</button>
        </div> , {
